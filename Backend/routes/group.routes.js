...
import { allGroup, createGroup, updateGroup, deleteGroup, groupReport, createReport, updateReport, deleteReport, TestcreateReport} from "../controllers/group.controller.js";
...
route.post("/create-report", TestcreateReport)
